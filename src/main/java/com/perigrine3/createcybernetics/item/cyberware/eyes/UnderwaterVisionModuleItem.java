...
public class UnderwaterVisionModuleItem extends Item implements ICyberwareItem {
    ...
    public UnderwaterVisionModuleItem(Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Component.translatable("tooltip.createcybernetics.eyeupgrades_underwatervision.energy").withStyle(ChatFormatting.RED));
        }
    }
