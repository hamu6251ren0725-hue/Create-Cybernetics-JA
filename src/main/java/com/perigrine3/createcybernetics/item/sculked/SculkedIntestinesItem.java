...
public class SculkedIntestinesItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public SculkedIntestinesItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.INTESTINES_ITEMS);
    }
