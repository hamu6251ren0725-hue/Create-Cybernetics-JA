...
public class PigstromModel<T extends PigstromEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(CreateCybernetics.MODID, "pigstrom"),
            "main"
    );
    ...
    public PigstromModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
                        ...
                        .texOffs(10, 7).addBox(-2.0F, -8.0F, -4.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.02F))
